...
class SecondHandPainter extends CustomPainter{
  ...
  void paint(Canvas canvas, Size size) {
    final radius= size.width/2;  // find the radius, which is half of the visible canvas we are using?
    ...
    canvas.translate(radius, radius);  // move the origin to the right half the screen, and down half the screen. this is a center operation
    ...
    path1.lineTo(0.0, radius/3);  // draws the hand. at 0 seconds, starts from the
    ...
    canvas.drawPath(path1, secondHandPaint);  // the second hand. remove this for a fun effect!
